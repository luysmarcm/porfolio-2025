					...
					<ul className="">
						<li className="flex flex-col space-y-4">
							<div className="flex space-x-4">
								<a
									href="https://www.instagram.com/monarca.lifeimprovement?igsh=bTAwZzVnZmJmNno="
									target="_blank"
									rel="noreferrer"
									className="text-center inline-flex items-center relative hover:text-white hover:underline "
								>
									<svg
									...
									<span className="px-4">monarca.lifeimprovement</span>
								</a>
							</div>
							<div className="flex space-x-4">
								<a
								...
								>
									...
									<span className="px-4">(+1) 321-330-6424 </span>
								</a>
							</div>
							<div className="flex space-x-4">
								<a
